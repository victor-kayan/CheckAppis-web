            ...
            <Row>
              ...
              <Descriptions title="" layout="vertical" style={{ color: "red" }}>
                ...
                <Descriptions.Item label="Endereço" color="red">
                  {apiario.endereco && apiario.endereco.logradouro}  -
                  {apiario.endereco && apiario.endereco.cidade.nome} -
              ...
              <Descriptions title="" layout="vertical">
                ...
                <Descriptions.Item bordered title="Custom Size" label="Teste" border size={50}>
