  ...
  render() {
    return (
      <div>
        ...
        >
          <Descriptions title="Informações do apiário" layout="vertical" style={{color: 'red'}}>
            <Descriptions.Item label="Nome" style={{color: 'red'}}>Apiário Bela Flora</Descriptions.Item>
