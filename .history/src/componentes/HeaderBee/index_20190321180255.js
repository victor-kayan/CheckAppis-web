                ...
                extra={
                    <Dropdown overlay={menu}>
                        <a className="ant-dropdown-link" href="#">
                            <label style={{ color: 'rgba(0, 0, 0, 0.45)' , fontSize: '13pt', marginRight: '10px' }}>Olá, {localStorage.getItem('userName')}</label>
                            <Avatar size="large" icon={localStorage.getItem('foto')} />
                        </a>
                    </Dropdown>
                }
            />
