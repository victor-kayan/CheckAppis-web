import { GET_ALL_APICULTORES, LOADING_APICULTOR, SAVE_APICULTOR, DELETE_APICULTOR, UPDATE_APICULTOR } from "./actionsTypes";
...
export const updateApicultor = ({ id }) => {
    console.log("Id do user", id)
    return dispatch => {
        ...
        Api.put(uris.UPDATE_APICULTOR + id)
            .then(response => {
                console.log(response)
                dispatch({
                    type: DELETE_APICULTOR,
