...
import {
    Form, Icon, Input, Button, Row, Typography
} from 'antd';
...
class Login extends Component {
    ...
    handleSubmit() {
        ...
        const logged  = this.props.login({ email, password });
                    ...
                    <Form className="login-form">
                        ...
                        <Form.Item>
                            {getFieldDecorator('userName', {
                                ...
                                <Input prefix={<Icon type="user" style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder="Nome" value={email} onChange={this.setEmail} />
                            )}
                        </Form.Item>
                        <Form.Item>
                            {getFieldDecorator('userName', {
