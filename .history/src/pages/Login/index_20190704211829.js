                    ...
                    <Form className="login-form" >
                        ...
                        <Form.Item>
                            <Row className="">
                                ...
                                <link style={{ float: 'right' }} className="login-form-forgot" onClick={this.esqueciSenha}>Recuperar senha</link>
                            </Row>
                            ...
                            <Row className="button">
                                <Button type="primary" onClick={this.handleSubmit} icon="facebook" type="primary" loading={this.props.loading} className="login-form-button button">
                                    Login com facebook
                                 </Button>
                            </Row>
