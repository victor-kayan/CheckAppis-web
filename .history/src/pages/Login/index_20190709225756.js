                    ...
                    <Form className="login-form" >
                        ...
                        <Form.Item>
                            ...
                            <Row className="button">
                                <Button type="primary" onClick={this.handleSubmit}loading={this.props.loading} className="login-form-button button">
                                    Entrar
                                 </Button>
                            </Row>
                            <Row className="button">
                                <Button type="primary" onClick={this.handleSubmit} icon="facebook" loading={this.props.loadingFacebook} className="login-form-button button">
                                    Login com facebook
                                 </Button>
                            </Row>
