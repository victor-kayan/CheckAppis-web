                    ...
                    <Form className="login-form" >
                        ...
                        <Form.Item>
                            {getFieldDecorator('email', {
                                ...
                                <Input prefix={<Icon type="mail" style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder="Email" setFieldsValue={email} onChange={this.setEmail} />
                            )}
                        </Form.Item>
                        ...
                        <Form.Item>
                            {getFieldDecorator('password', {
                                ...
                                <Input prefix={<Icon type="lock" style={{ color: 'rgba(0,0,0,.25)' }} />} type="password" setFieldsValue={password} placeholder="Senha" onChange={this.setPassword} />
                            )}
                        </Form.Item>
