...
class Login extends Component {
    ...
    //     if (this.props.logged == false && this.props.loading == false) {
    ...
    //         this.props.history.push("/dashboard");
    //     } else if (nextProps.logged == false && nextProps.loading == false) {
    //         this.setState({ error: true, message: "Email ou senha invalidos" });
    //         alert("Errrrrrrrrrrrro " + this.state.error)
    //     }
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.logged == true) {
            this.props.history.push("/dashboard");
        } else if (nextProps.logged == false && nextProps.loading == false && this.state.tentouLogar) {
            this.setState({ error: true, message: "Email ou senha invalidos" });
            alert("Errrrrrrrrrrrro " + this.state.error);
            this.setState({ tentouLogar: false });
