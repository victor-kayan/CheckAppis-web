    ...
    render() {
        ...
        return (
            <div className="container">
                <div className="box">
                    <div class="images">
                        <img src="http://apiariorainhadeouro.com.br/files/banner2.jpg" width="auto%" height="auto" />
                    </div>
                    <Form className="login-form" >
                        ...
                        <Form.Item>
                            ...
                            <strong>Bee<strong style={{ color: '#FFD915' }}>Check</strong> - Sistema de gerenciamento de colmeias e apiários</strong>
                        </Form.Item>
                    </Form>
