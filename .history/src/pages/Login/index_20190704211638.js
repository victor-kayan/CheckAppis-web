    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.logged === true) {
            ...
            if (nextProps.code >= 500) {
                this.setState({ alertVisible: true, message: "Aguarde!! Estamos tendo problemas no servidor" });
            } else {
                this.setState({ alertVisible: true, message: "Email e/ou senha incorretas" });
            }
            ...
            <div className="container">
                <div className="box">
                    ...
                    <Form className="login-form" >
                        ...
                        <AlertComponent  ref={'alert'} visible={alertVisible} type={'error'} message={message} />
                        ...
                        <Form.Item>
                            {getFieldDecorator('password', {
                                rules: [{
                                    min: 5, message: 'Sua senha tem que ter no minimo 5 caracteres',
                                }, {
                        ...
                        <Form.Item>
                            ...
                            <Row className="button">
                                <Button type="primary" onClick={this.handleSubmit} type="primary" loading={this.props.loading} className="login-form-button">
                                    Entrar
                                 </Button>
                            </Row>
                            <Row className="button">
                                <Button type="primary" onClick={this.handleSubmit} icon="facebook" type="primary" loading={this.props.loading} className="login-form-button">
                                    Login com facebook
                                 </Button>
                            </Row>
