         ...
         <Layout theme="default" style={{ minHeight: '100vh', textAlign: 'justify' }}>
            ...
            >
               ...
               <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
                  ...
                  <SubMenu
                     key="sub1"
                     title={<span><Icon type="team" /><span>Home</span></span>}
                  >
                  ...
                  <SubMenu
                     key="sub1"
                     title={<span><Icon type="team" /><span>Perfil</span></span>}
                  >
                  ...
                  >
                     <Menu.Item key="11">Listar</Menu.Item>
                  </SubMenu>
                  <SubMenu
                     key="sub4"
                     title={<span><Icon type="file-search" /><span>Relatórios</span></span>}
                  >
                     <Menu.Item key="12">Apiários</Menu.Item>
                     <Menu.Item key="13">Intervenções</Menu.Item>
                  </SubMenu>
               </Menu>
