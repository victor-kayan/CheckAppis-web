...
export class RelatorioIntervencao extends Component {
  ...
  render() {
    ...
    const { disabled, tipoIntervencao, orintacaoPapel, situacao } = this.state;
        ...
        >
          ...
          <Row gutter={24}>
            <Col span={24}>
              ...
              <Radio.Group onChange={this.onChange} value={tipoIntervencao}>
