  ...
  render() {
    ...
    return (
      <Layout.Content style={{ margin: "0 16px" }}>
        ...
        >
          <Button type="dashed" icon="warning" style={{backgroundColor: colors.COR_YELLOW_PRINCIPAL}}>Para cadastrar um novo apiário clique com botão direito do mouse</Button>
          <Row gutter={24}>
            <Col span={24}>
