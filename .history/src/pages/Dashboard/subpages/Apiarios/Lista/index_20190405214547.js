...
import { Table, Button, Layout, Tag, Popconfirm, Icon } from 'antd';
import BreadcrumBee from '../../../../../componentes/BreadcrumBee';
import pinMap from '../../../../../images/location.png';
        ...
        this.columns = [
            ...
            },
            {
                ...
                render: (text, record) => {
                    return (
                        <div>
                            <Button type="default" shape="circle" size="large" idUser={record.id} onClick={() => this.handleOpenModalEdit(record)} ><Icon type="step-forward" /></Button>
