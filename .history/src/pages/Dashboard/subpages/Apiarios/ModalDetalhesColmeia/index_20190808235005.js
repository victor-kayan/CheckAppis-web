...
class ModalDetalhesColmeia extends React.Component {
  ...
  render() {
    ...
    console.log('====================================');
    console.log('Loading', loadingColmeia);
    console.log('====================================');
              ...
              colmeias.map(colmeia => (
                <Col span={8} key={colmeia.id}>
                  <Card
                    ...
                    style={{ height: 150 }}
                    cover={<Avatar src={colmeiaIcon} size={60} style={{ padding: 10, textAlign: 'center' }}/>}
                  >
                    <Meta
                      // avatar={<Avatar src={colmeiaIcon} size={65} style={{ padding: 5 }}/>}
                      title={colmeia.nome}
