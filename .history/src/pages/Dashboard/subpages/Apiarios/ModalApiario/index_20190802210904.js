...
import { Modal, Button, notification, Icon, Spin } from "antd";
...
class ModalApiario extends React.Component {
  ...
  render() {
    ...
    const { isClicouButton } = this.state.clicouButtonSave;
        ...
        <Modal
          ...
          footer={[
            ...
            <Button
              key="submit"
              type="primary"
              loading={loadingApiario && isClicouButton}
