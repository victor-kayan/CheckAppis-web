    ...
    const columns = [
      ...
      },
      {
        ...
        render: () => {
          ...
          return (
            <div>
              <Radio.Group value={64}>
                <Button type="secondary" shape="circle" icon="download" size={65} />
                <Button type="primary" shape="circle" icon="download" size={65} /><Button type="primary" shape="circle" icon="download" size={30} />
              </Radio.Group>
            </div>
          );
        }
