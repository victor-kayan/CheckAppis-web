...
class ListApicultor extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.code === 204) {
      ...
      pagination.total = nextProps.data.list_apicultor.total;
      pagination.current = nextProps.data.list_apicultor.current_page;
      pagination.last_page = nextProps.data.list_apicultor.last_page;
