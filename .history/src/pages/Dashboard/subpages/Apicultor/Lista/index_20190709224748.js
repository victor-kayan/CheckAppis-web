...
class ListApicultor extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.code === 204) {
      ...
      pagination.total = nextProps.list_apicultor && nextProps.list_apicultor.total ? nextProps.list_apicultor.total : 3;
      pagination.current = nextProps.list_apicultor && nextProps.list_apicultor.current_page ? nextProps.list_apicultor.current_page : 3;
      pagination.last_page = nextProps.list_apicultor && nextProps.list_apicultor.last_page ? nextProps.list_apicultor.last_page : 3;
      pagination.pageSize = nextProps.list_apicultor && nextProps.list_apicultor.per_page ? nextProps.list_apicultor.per_page : 3;
  ...
  render() {
    ...
    console.log('Paginationsssssssssssss: ', this.state.pagination);
    const apicultores = this.props.list_apicultor || [];
    const { visible, visibleModalEdit, pagination } = this.state;
      ...
      <Layout.Content style={{ margin: '0 16px' }}>
        ...
        <div style={{ padding: 24, background: '#fff', minHeight: 360 }}>
          ...
          <Table
            ...
            pagination={{ pageSize: pagination.per_page || 2, current: pagination.current || 2,total: pagination.total || 5  }}
