...
class ListApicultor extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.code === 204) {
      ...
      pagination.last_page = nextProps.list_apicultor && nextProps.list_apicultor.last_page ? nextProps.list_apicultor.last_page : 1;
      pagination.per_page = nextProps.list_apicultor && nextProps.list_apicultor.per_page ? nextProps.list_apicultor.per_page : 1;
