  ...
  render() {
    ...
    return (
      <Layout.Content style={{ margin: "0 16px" }}>
        ...
        >
          ...
          >
            <Button
              ...
              style={{ marginBottom: 16, justifyContent: 'start', }}
              type="primary"
              icon="plus"
            >
              Novo apicultor
            ...
            <Button
              type="primary"
              style={{ marginBottom: 16, justifyContent: 'and', }}
        ...
        <ModalApicultor
          visible={visible}
          apicultor={this.state.apicultor}
          edicao={this.state.is_edicao}
          onClose={() =>
            this.setState({ visible: false, is_edicao: false, apicultor: {} })
          }
          onCancel={() =>
            this.setState({ visible: false, is_edicao: false, apicultor: {} })
          }
