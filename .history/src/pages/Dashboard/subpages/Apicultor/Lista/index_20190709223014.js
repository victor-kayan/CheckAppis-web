...
class ListApicultor extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.code === 204) {
      ...
      pagination.total = nextProps.list_apicultor.total && nextProps.list_apicultor.total ? nextProps.list_apicultor.total : 1;
      pagination.current = nextProps.list_apicultor.current_page && nextProps.list_apicultor.current_page ? nextProps.list_apicultor.current_page : 1;
      pagination.last_page = nextProps.list_apicultor.last_page && nextProps.list_apicultor.last_page ? nextProps.list_apicultor.last_page : 1;
