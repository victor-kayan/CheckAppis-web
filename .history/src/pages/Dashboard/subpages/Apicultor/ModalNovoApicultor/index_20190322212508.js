...
class ModalNovoApicultor extends React.Component {
  ...
  async handleSubmit(e) {
    ...
    this.props.form.validateFields((err, values) => {
     ...
     //   this.setState({ tentouLogar: true });
        await this.props.saveApicultor({ name: values.name, email: values.email, password: values.password, password_confirmation: values.password_confirmation });
      }
    });
  ...
  render() {
    ...
    const { visible, loadingButton } = this.state;
      ...
      <div>
        <Modal
          ...
          footer={[
            ...
            <Button key="submit" type="primary" loading={loadingButton} onClick={this.handleSubmit}>
              Salvar
            </Button>,
          ]} >
