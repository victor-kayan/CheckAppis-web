  ...
  componentWillReceiveProps(nextProps) {
    if (this.state.buttonClicou) {
      if (nextProps.code === 201) {
        this.setState({
          message: 'Apicultor cadastrado com sucesso', typeAlert: 'success',
          buttonClicou: false
        });
        message.success('Apicultor cadastrado com sucesso');
        this.props.onCancel();
          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            >
              {getFieldDecorator('name', {
                rules: [{
                  ...
                  min: 5, message: 'O campo tem que ter no minímo 5 caraceteres',
                },{
                  max: 50, message: 'O campo tem que ter no máximo 50 caraceteres',
                }],
              })(
            ...
            >
              {getFieldDecorator('password', {
                ...
                {
                  min: 5, message: 'O campo tem que ter no minímo 6 caracteres',
                },
                {
                  max: 30, message: 'O campo tem que ter no minímo 30 caraceteres',
                }
              ],
              })(
