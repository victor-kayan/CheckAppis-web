...
class ModalNovoApicultor extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.code === 201) {
      this.setState({ alertVisible: true, message: 'Usuário criado com sucesso', clico: true, typeAlert: 'success' });
    } else if(nextProps.clico){
      this.setState({
        alertVisible: true, message: 'Infelizmente houve algum problema',
        clico: true, typeAlert: 'error'
      });
    }
    this.setState({ clico: false});
  }
