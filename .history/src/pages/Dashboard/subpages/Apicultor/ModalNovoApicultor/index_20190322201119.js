            ...
            <Form {...formItemLayout} onSubmit={this.handleSubmit} >
              ...
              >
                {getFieldDecorator('userName', {
                  ...
                  <Input value={email} onChange={email => this.setState({ name })} prefix={<Icon type="user" style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder="Nome" />
                )}
              </Form.Item>
              ...
              >
                {getFieldDecorator('password', {
                  ...
                  <Input value={email} onChange={email => this.setState({ password })} prefix={<Icon type="user" style={{ color: 'rgba(0,0,0,.25)' }} />} type="Senha" />
                )}
              </Form.Item>
              ...
              >
                {getFieldDecorator('confirm', {
                  ...
                  <Input value={email} onChange={email => this.setState({ password })} prefix={<Icon type="user" style={{ color: 'rgba(0,0,0,.25)' }} />}
