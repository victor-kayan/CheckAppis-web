...
class ModalNovoApicultor extends React.Component {
  ...
  onChange = () => {
    this.props.getCidadesByUf('RN');
    this.refs.formNovoApicultor.setState({ cidades: this.props.list_cidades || []})
  }
  componentWillReceiveProps = (nextProps) => {
    ...
    return (
      ...
      >
        <AlertComponent
          ...
          message={message}
        />
        <FormaNovoApicultor ref="formNovoApicultor" onChange={this.onChange}  list_cidades={this.props.list_cidades} />;
      </Modal>
    );
  }
}
