            ...
            <Form {...formItemLayout} onSubmit={this.handleSubmit} >
              ...
              >
                {getFieldDecorator('userName', {
                  ...
                  <Input name={name} onChange={name => this.setState({ name })}
              ...
              >
                {getFieldDecorator('email', {
                  ...
                  <Input name={email} onChange={email => this.setState({ email })}
              ...
              >
                {getFieldDecorator('password', {
                  ...
                  <Input name={password} onChange={password => this.setState({ password })}
              ...
              >
                {getFieldDecorator('confirm', {
                  ...
                  <Input name={password_confirmation} onChange={password_confirmation => this.setState({ password_confirmation })}
