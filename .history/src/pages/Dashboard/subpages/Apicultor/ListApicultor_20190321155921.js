    ...
    const columns = [
      ...
      },
      {
        ...
        render: () => {
          ...
          return (
            <div>
                <Button type="secondary" shape="circle" icon="form" size={65} />
                <Button type="primary" shape="circle" icon="delete" size={65} /><Button type="primary" shape="circle" icon="download" size={30} />
            </div>
          );
        }
      }
