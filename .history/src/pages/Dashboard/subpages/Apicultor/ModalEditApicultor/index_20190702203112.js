...
import { Modal, Button, Form, Input, Icon, Layout, message } from 'antd';
            ...
            >
              {getFieldDecorator('password_confirmation', {
                ...
                <Input prefix={<Icon type="lock" style={{ color: 'rgba(0,0,0,.25)' }} />}
                  type="Confirmação de senha" onBlur={this.handleConfirmBlur} type="password" placeholder="Confirmar senha" />
              )}
            </Form.Item>
          </Form>
        </Modal>
