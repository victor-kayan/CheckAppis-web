...
class ModalEditApicultor extends React.Component {
  ...
  handleSubmit = async (e) => {
    const { idUser } = this.props.apicultor.id;
    console.log("Aquiiiiii",this.props.apicultor.id);
    alert(idUser)
    e.preventDefault();
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        this.props.updateApicultor({id:idUser});
      }
    });
  };
  ...
  render() {
    ...
    const { visible, onClose, onCancel, apicultor } = this.props;
