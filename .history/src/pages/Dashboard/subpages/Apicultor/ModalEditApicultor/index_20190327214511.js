...
class ModalEditApicultor extends React.Component {
  ...
  handleSubmit = async (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        this.props.updateApicultor(this.props.idUser);
      }
    });
  };
  ...
  render() {
    ...
    const { visible, onClose, onCancel, idUser } = this.props;
      ...
      <div>
        <Modal
          ...
          footer={[
            ...
            <Button key="submit" type="primary" loading={this.props.loading} onClick={ () => this.teste({ idUser })}>
              Salvar Edição
            </Button>
          ]}
