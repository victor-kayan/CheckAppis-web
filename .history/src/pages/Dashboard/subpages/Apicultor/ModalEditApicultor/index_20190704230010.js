...
import { updateApicultor, getApicultor } from '../../../../../redux/actions/apicultorActions';
  ...
  componentWillReceiveProps(nextProps) {
    if (this.state.buttonClicou) {
      if (nextProps.code === 200) {
        this.setState({
          message: 'Apicultor editado com sucesso', typeAlert: 'success'
        });
        message.success('Apicultor alterado com sucesso');
        this.props.onCancel();
      } else if (nextProps.code < 200 || nextProps.code >= 300) {
        this.setState({
          message: 'Infelizmente houve algum problema', typeAlert: 'error'
        });
  ...
  handleSubmit = async (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        this.props.updateApicultor({ id: this.props.apicultor.id, request: values});
      }
    });
  };
          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            >
              {getFieldDecorator('name', {
                ...
                {
                  max: 50, message: 'O nome tem que ter no máximo 50 caraceteres',
                }
              ],
              })(
            ...
            >
              {getFieldDecorator('password', {
                ...
                {
                  min: 6, message: 'A senha tem que ter no minimo 6',
                },
                {
                  max: 6, message: 'A senha tem que ter no máximo 30',
                }
              ],
              })(
            ...
            >
              {getFieldDecorator('password_confirmation', {
                ...
                <Input prefix={<Icon type="lock" style={{ color: 'rgba(0,0,0,.25)' }} />}
                  onBlur={this.handleConfirmBlur} type="password" placeholder="Confirmar senha" />
              )}
            </Form.Item>
          </Form>
        </Modal>
