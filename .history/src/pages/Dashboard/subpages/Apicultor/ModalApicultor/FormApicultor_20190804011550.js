            ...
            <Col span={12}>
              <Form.Item label="Cidade">
                {getFieldDecorator("cidade_id", {
                  initialValue:
                    (apicultor.endereco && apicultor.endereco.cidade.id) || [],
                  rules: [
                    {
                      required: true,
                  ...
                  >
                    {cidades && cidades.lenght ? (
                      ...
                      <Option value={apicultor.endereco && apicultor.endereco.cidade.id}>
                        {apicultor.endereco && apicultor.endereco.cidade.nome}
                      </Option>
                    )}
                  </Select>
                )}
