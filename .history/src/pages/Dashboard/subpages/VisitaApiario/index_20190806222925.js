...
class VisitaApiario extends React.Component {
  constructor(props) {
    ...
    this.handleModalIntervir = this.handleModalIntervir.bind(this);
    ...
    this.columns = [
      ...
      },
      {
        ...
        render: (text, record) => {
            // const formatarData = (dateString, format = 'DD/MM/YYYY HH:mm') => {
            //  moment.updateLocale(moment.locale('pt-br'), { invalidDate: '00/00/0000 00:00' });
          return (
            <div>
          ...
          return (
            <div>
              <Button
                ...
                icon="setting"
                size="default"
                onClick={() => this.handleModalIntervir(record)}
              >
              </Button>
              <Popconfirm
