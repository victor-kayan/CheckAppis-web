...
class VisitaApiario extends React.Component {
        ...
        render: (text, record) => {
          return (
            <div>
              <DatePicker
                disabled
                defaultValue={moment("01/01/2015", "01/01/2015")}
                format={"01/01/2015"}
              />
            </div>
          );
  ...
  openModalIntervir = record => {
    console.log('====================================');
    console.log('Valor Record', record.apiario_id);
    console.log('====================================');
    this.setState({ visitaId: record.id, modalVisible: true });
  };
  ...
  render() {
    ...
    const { pagination, modalVisible, visitaId } = this.state;
