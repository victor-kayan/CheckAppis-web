...
import { Modal, Button, Form, Icon, notification, Input, Row, Col, DatePicker } from "antd";
    ...
    return (
      ...
      >
        <Row gutter={8}>
          ...
          <br/>
          <Col span={24}>
            <DatePicker onChange={this.onChangeDate} /> até <DatePicker onChange={this.onChangeDate}/>
          </Col>
        </Row>
      </Modal>
    );
