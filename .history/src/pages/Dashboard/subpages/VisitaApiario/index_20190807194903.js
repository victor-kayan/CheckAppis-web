...
import { getAllApiariosVisitas, deleteVisitaApiario } from "../../../../redux/actions/visitasApiarioActions";
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.code === 204) {
      notification.open({
        ...
        description: "Visita rvxvxcemovida com sucesso",
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ getAllApiariosVisitas, deleteVisitaApiario }, dispatch);
}
