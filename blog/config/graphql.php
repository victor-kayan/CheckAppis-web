...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'publicacao' => \App\GraphQL\Query\PublicacaoQuery::class,
                'comentario' => \App\GraphQL\Query\ComentarioQuery::class,
            ],
            'mutation' => [
                'createPublicacao' => \App\GraphQL\Mutation\CreatePublicacaoMutation::class,
                'createComentario' => \App\GraphQL\Mutation\CreateComentarioMutation::class,
            ]
        ]
    ],
     ...
     */
    'types' => [
        App\GraphQL\Type\PublicacaoType::class,
        App\GraphQL\Type\ComentarioType::class,
    ],
